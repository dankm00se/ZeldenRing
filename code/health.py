...
class Health(pygame.sprite.Sprite):
    def __init__(self, groups, pos):
        ...
        self.pickup_sound = pygame.mixer.Sound('./audio/health/pickup.wav')
        ...
        for sprite in self.visible_sprites:
            if(type(sprite) == Player):
                if sprite.hitbox.colliderect(self.hitbox) and not self.added:
                    #if it's a player, add 1 to potion for the player and commit neckrope                    
                    sprite.potions += 1
                    self.added = True
    ...
    def import_graphics(self):
        ...
        main_path = f'./graphics/health/'
        
        self.animations['idle'] = import_folder(main_path, 'health')
